...
(* OASIS_START *)
(* DO NOT EDIT (digest: 74d548c7fbdaf9630e86f2a198c7de43) *)
(*
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("fftw3", None);
                           FindlibPackage ("portaudio", None);
                           FindlibPackage ("sdl", None);
                           FindlibPackage ("sdl.sdlimage", None);
                           FindlibPackage ("sdl.sdlttf", None)
                        ];
